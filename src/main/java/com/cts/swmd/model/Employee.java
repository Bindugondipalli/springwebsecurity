...
public class Employee {
	...
	@Max(value=45000,message="basic can not be less than 4.5lakh")
	...
	@Pattern(regexp="[1-9][0-9]{9}",message="Mobile number is expected to be 10 digits not less than or above 10")
	@NotNull(message="mobile number can not be omitted.")
	private String mobileNumber;
	@Email(message="Email must a valid one")
